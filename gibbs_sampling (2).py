...
Original file is located at
    https://colab.research.google.com/drive/14_6o5DNG_C4eyVKO0kT6dubBD1XXtEw4
"""
...
# Assuming you uploaded the file named 'rowonelda.csv'
df = pd.read_csv(io.BytesIO(uploaded['rowonelda.csv']))
print(df.head())
...
additional_stopwords = ["engineering", "design", "problem", "statement", "small-scale", "like", "able", "urin"]  # Replace this list with your stopwords
...
topics = [
    {"Topic": 0, "Words": {"car": 0.018, "need": 0.017, "engin": 0.015, "food": 0.014, "combust": 0.013}},
    {"Topic": 1, "Words": {"heat": 0.023, "engin": 0.018, "temperatur": 0.018, "blade": 0.013, "water": 0.013}},
    {"Topic": 2, "Words": {"payload": 0.013, "cork": 0.013, "paper": 0.013, "team": 0.011, "abil": 0.011}},
    {"Topic": 3, "Words": {"water": 0.013, "need": 0.012, "project": 0.012, "abl": 0.011, "student": 0.010}},
    {"Topic": 4, "Words": {"model": 0.015, "leg": 0.015, "team": 0.015, "need": 0.014, "peopl": 0.012}},
    {"Topic": 5, "Words": {"engin": 0.028, "improv": 0.015, "worker": 0.015, "manufactur": 0.013, "product": 0.011}},
    {"Topic": 6, "Words": {"creat": 0.020, "geometri": 0.015, "student": 0.015, "small": 0.012, "communiti": 0.011}},
    {"Topic": 7, "Words": {"devic": 0.013, "materi": 0.011, "need": 0.011, "lock": 0.011, "student": 0.011}},
    {"Topic": 8, "Words": {"dispens": 0.016, "line": 0.014, "washer": 0.014, "bucket": 0.014, "fiber": 0.012}},
    {"Topic": 9, "Words": {"need": 0.023, "assembl": 0.021, "devic": 0.020, "board": 0.020, "time": 0.017}},
    {"Topic": 10, "Words": {"devic": 0.015, "manufactur": 0.015, "compani": 0.013, "chair": 0.013, "machin": 0.011}},
    {"Topic": 11, "Words": {"need": 0.020, "rover": 0.014, "abl": 0.013, "grill": 0.013, "cell": 0.010}},
    {"Topic": 12, "Words": {"run": 0.015, "pool": 0.014, "process": 0.013, "drone": 0.013, "devic": 0.012}},
    {"Topic": 13, "Words": {"energi": 0.025, "build": 0.024, "satellit": 0.014, "abl": 0.010, "beam": 0.009}},
    {"Topic": 14, "Words": {"lift": 0.024, "conveyor": 0.012, "water": 0.011, "pallet": 0.010, "engin": 0.009}},
    {"Topic": 15, "Words": {"size": 0.011, "requir": 0.010, "pump": 0.010, "assum": 0.010, "state": 0.010}},
    {"Topic": 16, "Words": {"compani": 0.020, "product": 0.016, "larg": 0.011, "speed": 0.010, "packag": 0.009}},
    {"Topic": 17, "Words": {"engin": 0.022, "requir": 0.017, "project": 0.013, "current": 0.009, "process": 0.009}},
    {"Topic": 18, "Words": {"dish": 0.016, "electr": 0.016, "pfas": 0.016, "product": 0.015, "marker": 0.014}},
    {"Topic": 19, "Words": {"vinyl": 0.030, "bridg": 0.020, "need": 0.016, "machin": 0.016, "process": 0.014}}
]
...
clusters = {
    'Cluster 8': ['engin', 'product', 'manufactur', 'compani', 'creat'],
    'Cluster 9': ['need', 'abl', 'devic', 'time', 'water'],
'Cluster 5': ['rover', 'abl', 'need', 'grill', 'devic'],
'Cluster 3': ['bridg', 'water', 'slide', 'beam', 'feet'],
'Cluster 0': ['compani', 'bottl', 'issu', 'process', 'line'],
'Cluster 7': ['satellit', 'rocket', 'deploy', 'payload', 'effect'],
'Cluster 1': ['heat', 'water', 'pool', 'temperatur', 'calcul'],
'Cluster 6': ['devic', 'process', 'run', 'vinyl', 'model'],
'Cluster 4': ['conveyor', 'pallet', 'display', 'product', 'custom'],
'Cluster 2': ['drive', 'peopl', 'hour', 'traffic', 'time']
